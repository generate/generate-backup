...
module.exports = function(app) {
  ...
  /**
   * Scaffold out a(n) backup project. Also aliased as the [default](#default) task.
   *
   * ```sh
   * $ gen backup:backup
   * ```
  ...
  app.task('backup', ['files', 'generator', 'index']);
  ...
  /**
   * Scaffold out a new backup project. This task is an alias for the [backup](#backup)
